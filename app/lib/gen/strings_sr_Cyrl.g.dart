...
class _Translations$receiveOptionsPage$sr_Cyrl extends Translations$receiveOptionsPage$sr {
  ...
  @override
  String get appDirectory => '(像素快传 фолдер)';
  @override
...
class _Translations$webSharePage$sr_Cyrl extends Translations$webSharePage$sr {
  ...
  @override
  String get encryptionHint => '像素快传 користи самопотписани сертификат. Морате га прихватити у свом прегледачу.';
  @override
...
class _Translations$aboutPage$sr_Cyrl extends Translations$aboutPage$sr {
  ...
  // Translations
  @override
  String get title => 'О 像素快传-у';
  @override
  List<String> get description => [
    '像素快传 је бесплатна апликација отвореног кода која вам омогућава да безбедно делите фајлове и поруке са уређајима у близини преко ваше локалне мреже, без потребе за интернет везом.',
...
class _Translations$donationPage$sr_Cyrl extends Translations$donationPage$sr {
  ...
  @override
  String get info => '像素快传 је бесплатан, отвореног кода и без икаквих огласа. Ако вам се свиђа апликација, можете подржати развој донацијом.';
  @override
...
class _Translations$networkInterfacesPage$sr_Cyrl extends Translations$networkInterfacesPage$sr {
  ...
  @override
  String get info =>
      'Подразумевано, 像素快传 користи све доступне мрежне интерфејсе. Овде можете изузети нежељене мреже. Морате рестартовати сервер да би се примениле промене.';
}
...
class _Translations$settingsTab$general$sr_Cyrl extends Translations$settingsTab$general$sr {
  ...
  @override
  String get showInContextMenu => 'Прикажи 像素快传 у контекстуалном менију';
  @override
...
class _Translations$settingsTab$other$sr_Cyrl extends Translations$settingsTab$other$sr {
  ...
  @override
  String get support => 'Подржите 像素快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$sr_Cyrl extends Translations$dialogs$localNetworkUnauthorized$sr {
  ...
  @override
  String get description => '像素快传 не може да пронађе друге уређаје без дозволе за скенирање локалне мреже. Дајте ову дозволу у подешавањима.';
  @override
...
class _Translations$dialogs$sendModeHelp$sr_Cyrl extends Translations$dialogs$sendModeHelp$sr {
  ...
  @override
  String get link => 'Примаоци који немају инсталиран 像素快传 могу преузети изабране фајлове отварањем линка у свом прегледачу.';
}
