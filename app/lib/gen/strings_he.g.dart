...
class _Translations$receiveOptionsPage$he extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(תיקיית PixelFile)';
  @override
...
class _Translations$webSharePage$he extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'PixelFile משתמש בתעודה עצמית. עליך לאשר אותה בדפדפן.';
  @override
...
class _Translations$aboutPage$he extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'אודות PixelFile';
  @override
  List<String> get description => [
    'PixelFile היא אפליקציית קוד פתוח חינמית המאפשרת לשתף קבצים והודעות בצורה מאובטחת עם מכשירים קרובים דרך הרשת המקומית מבלי להזדקק לחיבור לאינטרנט.',
...
class _Translations$donationPage$he extends Translations$donationPage$en {
  ...
  @override
  String get info => 'אפליקציית PixelFile היא חינמית, קוד פתוח וללא פרסומות. אם אתה אוהב את האפליקציה, אתה יכול לתמוך בפיתוח באמצעות תרומה.';
  @override
...
class _Translations$tray$he extends Translations$tray$en {
  ...
  @override
  String get close => 'צא מ-PixelFile';
  @override
...
class _Translations$networkInterfacesPage$he extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'כברירת מחדל, PixelFile משתמש בכל ממשקי הרשת הזמינים. באפשרותך להסיר רשתות שאינן רצויות כאן. עליך להפעיל מחדש את השרת כדי להחיל את השינויים.';
  @override
  String get preview => 'תצוגה מקדימה';
  @override
...
class _Translations$settingsTab$general$he extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'הצג את PixelFile בתפריט ההקשר';
  @override
...
class _Translations$settingsTab$other$he extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'תמיכה ב-PixelFile';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$he extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'ל־PixelFile אין אפשרות למצוא מכשירים אחרים ללא הרשאה לסריקת הרשת המקומית. אנא הענק את ההרשאה הזו בהגדרות.';
  @override
...
class _Translations$dialogs$sendModeHelp$he extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'מקבלים ש-PixelFile לא מותקן אצלם יוכלו להוריד את הקבצים שנבחרו על ידי פתיחת הקישור בדפדפן שלהם.';
}
