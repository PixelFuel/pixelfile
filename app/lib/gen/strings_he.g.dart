...
class _Translations$receiveOptionsPage$he extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(תיקיית 像素快传)';
  @override
...
class _Translations$webSharePage$he extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 משתמש בתעודה עצמית. עליך לאשר אותה בדפדפן.';
  @override
...
class _Translations$aboutPage$he extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'אודות 像素快传';
  @override
  List<String> get description => [
    '像素快传 היא אפליקציית קוד פתוח חינמית המאפשרת לשתף קבצים והודעות בצורה מאובטחת עם מכשירים קרובים דרך הרשת המקומית מבלי להזדקק לחיבור לאינטרנט.',
...
class _Translations$donationPage$he extends Translations$donationPage$en {
  ...
  @override
  String get info => 'אפליקציית 像素快传 היא חינמית, קוד פתוח וללא פרסומות. אם אתה אוהב את האפליקציה, אתה יכול לתמוך בפיתוח באמצעות תרומה.';
  @override
...
class _Translations$networkInterfacesPage$he extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'כברירת מחדל, 像素快传 משתמש בכל ממשקי הרשת הזמינים. באפשרותך להסיר רשתות שאינן רצויות כאן. עליך להפעיל מחדש את השרת כדי להחיל את השינויים.';
  @override
  String get preview => 'תצוגה מקדימה';
  @override
...
class _Translations$settingsTab$general$he extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'הצג את 像素快传 בתפריט ההקשר';
  @override
...
class _Translations$settingsTab$other$he extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'תמיכה ב-像素快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$he extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'ל־像素快传 אין אפשרות למצוא מכשירים אחרים ללא הרשאה לסריקת הרשת המקומית. אנא הענק את ההרשאה הזו בהגדרות.';
  @override
...
class _Translations$dialogs$sendModeHelp$he extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'מקבלים ש-像素快传 לא מותקן אצלם יוכלו להוריד את הקבצים שנבחרו על ידי פתיחת הקישור בדפדפן שלהם.';
}
