...
class _Translations$receiveOptionsPage$it extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(cartella 像素快传)';
  @override
...
class _Translations$webSharePage$it extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 utilizza un certificato autofirmato. Devi accettarlo nel browser.';
  @override
...
class _Translations$aboutPage$it extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Informazioni su 像素快传';
  @override
  List<String> get description => [
    '像素快传 è un\'app gratuita e open-source che consente di condividere file e messaggi in modo sicuro con dispositivi vicini sulla tua rete locale, senza bisogno di una connessione internet.',
...
class _Translations$donationPage$it extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 è gratuito, open-source e privo di pubblicità. Se ti piace l\'applicazione, puoi supportarne lo sviluppo con una donazione.';
  @override
...
class _Translations$networkInterfacesPage$it extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Per impostazione predefinita, 像素快传 utilizza tutte le interfacce di rete disponibili. È possibile escludere le reti indesiderate. È necessario riavviare il server per applicare le modifiche.';
  @override
  String get preview => 'Anteprima';
  @override
...
class _Translations$settingsTab$general$it extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Mostra 像素快传 nel menù contestuale';
  @override
...
class _Translations$settingsTab$other$it extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Supporta 像素快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$it extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '像素快传 non può trovare altri dispositivi senza il permesso per la scansione della rete locale. Puoi concedere questo permesso nelle impostazioni.';
  @override
...
class _Translations$dialogs$sendModeHelp$it extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'I destinatari che non hanno installato 像素快传 possono scaricare i file selezionati aprendo il link nel loro browser.';
}
