...
class _Translations$networkInterfacesPage$gu extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'ડિફૌલ્ટ રૂપે, 像素快传 બધા ઉપલબ્ધ નેટવર્ક ઇન્ટરફેસ વાપરશે. તમે અહી નજોયતા નેટવર્ક ને કાઢી શકો છો. બદલાવ જોયા માટે તમને સર્વર ને ફરી ચાલુ કરવું પડસે.';
}
...
class _Translations$settingsTab$general$gu extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'કૉટેક્સ્ટ મેન્યુ માં 像素快传 દેખાડો';
}
...
class _Translations$dialogs$sendModeHelp$gu extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'જે પ્રાપ્તકર્તાઓ પાસે 像素快传 સ્થાપિત નથી તેઓ તેમના બ્રાઉઝરમાં લિંક ખોલીને પસંદ કરેલી ફાઈલો ડાઉનલોડ કરી શકે છે.';
}
