...
class _Translations$receiveOptionsPage$ar extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(مجلد PixelFile)';
  @override
...
class _Translations$webSharePage$ar extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'يستخدم تطبيق PixelFile شهادة موقع ذاتية التوقيع. يجب عليك قبولها في المتصفح.';
  @override
...
class _Translations$aboutPage$ar extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'عن PixelFile';
  @override
  List<String> get description => [
    'PixelFile هو تطبيق مجاني مفتوح المصدر يسمح لك بمشاركة الملفات والرسائل بشكل آمن مع الأجهزة القريبة عبر شبكتك المحلية دون الحاجة إلى اتصال بالإنترنت.',
...
class _Translations$donationPage$ar extends Translations$donationPage$en {
  ...
  @override
  String get info => 'PixelFile مجاني ومفتوح المصدر وبدون أي إعلانات. إذا أعجبك التطبيق، يمكنك دعم التطوير بالتبرع.';
  @override
...
class _Translations$tray$ar extends Translations$tray$en {
  ...
  @override
  String get close => 'أنهِ PixelFile';
  @override
...
class _Translations$networkInterfacesPage$ar extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'بشكل افتراضي، يستخدم PixelFile جميع واجهات الشبكة المتاحة. يمكنك استبعاد الشبكات غير المرغوب فيها هنا. تحتاج إلى إعادة تشغيل الخادم لتطبيق التغييرات.';
  @override
  String get preview => 'معاينة';
}
...
class _Translations$settingsTab$general$ar extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'إظهار PixelFile في قائمة السياق';
  @override
...
class _Translations$settingsTab$other$ar extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'دعم PixelFile';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ar extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'لا يمكن ل PixelFile العثور على الأجهزة الأخرى بدون الإذن بفحص الشبكة المحلية. يُرجى منح هذا الإذن في الإعدادات.';
  @override
...
class _Translations$dialogs$sendModeHelp$ar extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'يمكن للمستلمين الذين لا يحتوون على PixelFile تنزيل الملفات المحددة عن طريق فتح الرابط في متصفحهم.';
}
