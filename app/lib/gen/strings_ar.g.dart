...
class _Translations$receiveOptionsPage$ar extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(مجلد 像素快传)';
  @override
...
class _Translations$webSharePage$ar extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'يستخدم تطبيق 像素快传 شهادة موقع ذاتية التوقيع. يجب عليك قبولها في المتصفح.';
  @override
...
class _Translations$aboutPage$ar extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'عن 像素快传';
  @override
  List<String> get description => [
    '像素快传 هو تطبيق مجاني مفتوح المصدر يسمح لك بمشاركة الملفات والرسائل بشكل آمن مع الأجهزة القريبة عبر شبكتك المحلية دون الحاجة إلى اتصال بالإنترنت.',
...
class _Translations$donationPage$ar extends Translations$donationPage$en {
  ...
  @override
  String get info => '像素快传 مجاني ومفتوح المصدر وبدون أي إعلانات. إذا أعجبك التطبيق، يمكنك دعم التطوير بالتبرع.';
  @override
...
class _Translations$networkInterfacesPage$ar extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'بشكل افتراضي، يستخدم 像素快传 جميع واجهات الشبكة المتاحة. يمكنك استبعاد الشبكات غير المرغوب فيها هنا. تحتاج إلى إعادة تشغيل الخادم لتطبيق التغييرات.';
  @override
  String get preview => 'معاينة';
}
...
class _Translations$settingsTab$general$ar extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'إظهار 像素快传 في قائمة السياق';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ar extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'لا يمكن ل 像素快传 العثور على الأجهزة الأخرى بدون الإذن بفحص الشبكة المحلية. يُرجى منح هذا الإذن في الإعدادات.';
  @override
...
class _Translations$dialogs$sendModeHelp$ar extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'يمكن للمستلمين الذين لا يحتوون على 像素快传 تنزيل الملفات المحددة عن طريق فتح الرابط في متصفحهم.';
}
