...
class _Translations$receiveOptionsPage$th extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(โฟลเดอร์ของ PixelFile)';
  @override
...
class _Translations$webSharePage$th extends Translations$webSharePage$en {
  ...
  String get encryptionHint =>
      'PixelFile ใช้ใบรับรองอุปกรณ์จากเว็บเบราเซอร์ (self-signed certificate) คุณต้องกดยอมรับใบรับรองนี้ในเบราว์เซอร์บนอุปกรณ์ของคุณ';
  @override
...
class _Translations$aboutPage$th extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'เกี่ยวกับ PixelFile';
  @override
  List<String> get description => [
    'PixelFile เป็นแอปโอเพ่นซอร์สที่คุณสามารถดาวน์โหลดมาใช้ได้ฟรีโดยไม่เสียค่าใช้จ่าย ซึ่งตัวแอปจะช่วยให้คุณสามารถแบ่งปันไฟล์และข้อความกับอุปกรณ์ใกล้เคียงได้อย่างปลอดภัยผ่านเครือข่ายท้องถิ่นที่เชื่อมต่อร่วมกันโดยไม่จำเป็นต้องเชื่อมต่ออินเทอร์เน็ต',
...
class _Translations$donationPage$th extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'PixelFile เป็นแอปโอเพ่นซอร์สที่คุณสามารถดาวน์โหลดมาใช้ได้ฟรีโดยไม่เสียค่าใช้จ่ายหรือโฆษณาแฝง หากคุณชื่นชอบแอปนี้ คุณสามารถสนับสนุนการพัฒนาแอปได้ด้วยการบริจาคเงิน';
  @override
...
class _Translations$tray$th extends Translations$tray$en {
  ...
  @override
  String get close => 'ออกจากแอป PixelFile';
  @override
...
class _Translations$networkInterfacesPage$th extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'ตามค่าเริ่มต้น PixelFile จะใช้อินเทอร์เฟซเครือข่ายที่มีอยู่ทั้งหมด คุณสามารถยกเว้นเครือข่ายที่ไม่ต้องการได้ที่นี่ คุณต้องรีสตาร์ทเซิร์ฟเวอร์เพื่อใช้การเปลี่ยนแปลง';
  @override
...
class _Translations$settingsTab$general$th extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'แสดง PixelFile ในเมนูคลิกขวา';
  @override
...
class _Translations$settingsTab$other$th extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'สนับสนุน PixelFile';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$th extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'PixelFile ไม่สามารถค้นหาอุปกรณ์อื่นได้หากคุณไม่ให้สิทธิ์การสแกนเครือข่ายที่อุปกรณ์นี้กำลังเชื่อมต่ออยู่ โปรดอนุญาตให้สิทธิ์ในการสแกนนี้ในหน้าการตั้งค่า';
  @override
...
class _Translations$dialogs$sendModeHelp$th extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'ผู้รับที่ไม่ได้ติดตั้งแอป PixelFile สามารถดาวน์โหลดไฟล์ที่เลือกไว้ในรายการได้โดยการเปิดลิงก์ในเบราว์เซอร์';
}
