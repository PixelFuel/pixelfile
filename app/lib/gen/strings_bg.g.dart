...
class _Translations$receiveOptionsPage$bg extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(папка на 像素快传)';
  @override
...
class _Translations$webSharePage$bg extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 използва самоподписан сертификат. Трябва да го приемете във вашия браузър.';
  @override
...
class _Translations$aboutPage$bg extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Относно 像素快传';
  @override
  List<String> get description => [
    '像素快传 е безплатно приложение с отворен код, което ви позволява сигурно да споделяте файлове и съобщения с устройства наблизо през вашата локална мрежа, без да се нуждаете от интернет връзка.',
...
class _Translations$donationPage$bg extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 е безплатен, с отворен код и без никакви реклами. Ако харесвате приложението, можете да подкрепите разработката с дарение.';
  @override
...
class _Translations$tray$bg extends Translations$tray$en {
  ...
  @override
  String get close => 'Излезте от 像素快传';
  @override
...
class _Translations$networkInterfacesPage$bg extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'По подразбиране, 像素快传 използва всички налични мрежови интерфейси. Тук можете да изключите нежелани мрежи. Трябва да рестартирате сървъра, за да приложите промените.';
}
...
class _Translations$settingsTab$general$bg extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Покажи 像素快传 в контекстното меню';
  @override
...
class _Translations$settingsTab$other$bg extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Поддръжка на 像素快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$bg extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '像素快传 не може да намери други устройства без разрешение за сканиране на локалната мрежа. Моля, предоставете това разрешение в настройките.';
  @override
...
class _Translations$dialogs$sendModeHelp$bg extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Получателите, които нямат инсталиран 像素快传, могат да изтеглят избраните файлове, като отворят връзката в своя браузър.';
}
