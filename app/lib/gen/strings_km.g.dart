...
class _Translations$receiveOptionsPage$km extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(ថតឯកសារ PixelFile)';
  @override
...
class _Translations$webSharePage$km extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'PixelFile ប្រើវិញ្ញាបនបត្រដែលចុះហត្ថលេខាដោយខ្លួនឯង។ អ្នកត្រូវទទួលយកវានៅក្នុងកម្មវិធី​ browser ។';
  @override
...
class _Translations$aboutPage$km extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'អំពី PixelFile';
  @override
  List<String> get description => [
    'PixelFile គឺជាកម្មវិធីដែលប្រើដោយឥតគិតថ្លៃ និងបើកចំហនូវប្រភពកូដ ដែលអនុញ្ញាតឱ្យអ្នកអាចចែករំលែកឯកសារ និងសារដោយសុវត្ថិភាពជាមួយនឹងឧបករណ៍ដែលនៅជិតៗដែលនៅលើបណ្តាញមូលដ្ឋានរួមគ្នាដោយមិនចាំបាច់ភ្ជាប់អ៊ីនធឺណិត។',
    'កម្មវិធីនេះគឺអាចដំណើរការនៅលើគ្រប់ប្រព័ន្ធប្រតិបត្តិការទាំងអស់រួមមានដូចជា Android, iOS, macOS, Windows និង Linux ។ អ្នកអាចស្វែងរក និងទាញយកបានច្រើនវិធីសាស្ត្រតាមរយៈគេហទំព័រផ្លូវការរបស់ PixelFile ។',
  ];
  @override
...
class _Translations$donationPage$km extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'PixelFile ជាកម្មវិធីដែលឥតគិតថ្លៃ, បើកបង្ហាញប្រភពកូដជាសាធារណៈ និងមិនមានការបង្ហាញនូវផ្ទាំងពាណិជ្ជកម្មរំខានឡើយ។ ប្រសិនបើអ្នកពេញចិត្តកម្មវិធីនេះ​ និងចង់ជួយពួកយើង, អ្នកអាចចូលរួមលើកស្ទួយការអភិវឌ្ឍន៍កម្មវិធីនេះជាមួយពួកយើងតាមរយៈការឧបត្ថម្ភជាថវិកា។';
  @override
...
class _Translations$tray$km extends Translations$tray$en {
  ...
  @override
  String get close => 'ចាកចេញពីកម្មវិធី PixelFile';
  @override
...
class _Translations$settingsTab$general$km extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'បង្ហាញ PixelFile in នៅលើរបារម៉ឺនុយ';
  @override
...
class _Translations$settingsTab$other$km extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'ជួយគាំទ្រ PixelFile';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$km extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'PixelFile មិន​អាច​រក​ឃើញ​ឧបករណ៍​ផ្សេង​ទៀត​ដោយ​មិន​មាន​ការ​អនុញ្ញាត​ក្នុង​ការ​ស្កែន​បណ្តាញរួមគ្នា​ទេ។ សូមផ្តល់ការអនុញ្ញាតនេះនៅក្នុងការកំណត់។';
  @override
...
class _Translations$dialogs$sendModeHelp$km extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'អ្នកទទួលដែលមិនបានដំឡើង PixelFile អាចទាញយកឯកសារដែលបានជ្រើសរើសដោយបើកតំណនៅក្នុងកម្មវិធី browser របស់ពួកគេ។';
}
