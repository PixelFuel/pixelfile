...
class _Translations$webSharePage$ur extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 براؤزر میں استعمال کرنے کیلئے آپ کوخود سائن کردہ سرٹیفکیٹ قبول کرنا ہوگا۔';
  @override
...
class _Translations$aboutPage$ur extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'کے بارے میں 像素快传';
  @override
  List<String> get description => [
    '像素快传 ایک مفت، اوپن سورس ایپ ہے جو آپ کو انٹرنیٹ کنکشن کی ضرورت کے بغیر اپنے مقامی نیٹ ورک کے ذریعے قریبی آلات کے ساتھ فائلیں اور پیغامات محفوظ طریقے سے شیئر کرنے کی اجازت دیتی ہے۔',
...
class _Translations$donationPage$ur extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 مفت، اوپن سورس ہے اور اس میں کوئی اشتہارات نہیں ہیں۔ اگر آپ کو ایپ پسند ہے، تو آپ عطیہ کے ذریعے ترقی کی حمایت کر سکتے ہیں۔';
  @override
...
class _Translations$settingsTab$general$ur extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'سیاق و سباق کے مینو میں 像素快传 دکھائیں';
  @override
...
class _Translations$settingsTab$other$ur extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => '像素快传 کی حمایت کریں';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ur extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'لوکل نیٹ ورک کا سکین کرنے کی اجازت کے بغیر 像素快传، دیگر ڈیوائسز تلاش نہیں کرسکتا ہے۔ براہ کرم ترتیبات میں اس اجازت کو منظور کریں۔';
  @override
...
class _Translations$dialogs$sendModeHelp$ur extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => '像素快传 نصب نہیں ہونے والے رسیورز منتخب شدہ فائلز کو لنک اپنے براؤزر میں کھولنے سے ڈاؤن لوڈ کر سکتے ہیں۔';
}
