...
class _Translations$webSharePage$id extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 menggunakan sertifikat self-signed. Anda perlu menerimanya di peramban.';
  @override
...
class _Translations$aboutPage$id extends Translations$aboutPage$en {
  ...
  List<String> get description => [
    '像素快传 adalah aplikasi gratis dan bersumber terbuka yang memungkinkan Anda untuk membagikan berkas dan pesan secara aman dengan perangkat lain yang terhubung pada jaringan lokal tanpa memerlukan koneksi internet atau paket data.',
...
class _Translations$donationPage$id extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 adalah aplikasi gratis, bersumber terbuka, dan bebas iklan. Jika Anda menyukai aplikasi ini, mohon berikan kami dukungan dengan cara memberikan donasi.';
  @override
...
class _Translations$networkInterfacesPage$id extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Secara default, 像素快传 menggunakan semua antarmuka jaringan yang tersedia. Anda dapat mengecualikan jaringan yang tidak diinginkan di sini. Anda perlu memulai ulang server untuk menerapkan perubahan.';
}
...
class _Translations$settingsTab$general$id extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Tampilkan 像素快传 di menu konteks';
  @override
...
class _Translations$settingsTab$other$id extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Dukung 像素快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$id extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '像素快传 tidak dapat menemukan perangkat lain tanpa izin untuk memindai jaringan lokal. Mohon berikan izin ini di pengaturan.';
  @override
...
class _Translations$dialogs$sendModeHelp$id extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Penerima yang tidak memiliki 像素快传 dapat mengunduh berkas yang dipilih dengan membuka tautan di peramban.';
}
