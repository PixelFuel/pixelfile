...
class _Translations$receiveOptionsPage$ja extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(PixelFile フォルダー)';
  @override
...
class _Translations$webSharePage$ja extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'PixelFileは自己署名証明書を使用しているため、ブラウザーで証明書を許可する必要があります。';
  @override
...
class _Translations$aboutPage$ja extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'PixelFileについて';
  @override
  List<String> get description => [
    'PixelFileは無料のオープンソースアプリで、インターネットに接続することなく、ローカルネットワーク経由で近くにあるデバイスとファイルやメッセージを安全に共有することができます。',
...
class _Translations$donationPage$ja extends Translations$donationPage$en {
  ...
  String get title => '寄付';
  @override
  String get info => 'PixelFileは無料かつオープンソースで、広告を一切含みません。もしアプリを気に入っていただけたら、寄付で開発を支援することができます。';
  @override
...
class _Translations$networkInterfacesPage$ja extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info => 'デフォルトでは、PixelFile は利用可能なすべてのネットワークインターフェースを使用します。不要なネットワークを除外するには、ここで設定できます。変更を適用するには、サーバーを再起動する必要があります。';
}
...
class _Translations$settingsTab$general$ja extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'コンテキストメニューにPixelFileを表示';
  @override
...
class _Translations$settingsTab$other$ja extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'PixelFileを支援';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ja extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'ローカルネットワークをスキャンする権限がないと、PixelFileは他のデバイスを見つけることができません。設定よりこの権限を付与してください。';
  @override
...
class _Translations$dialogs$sendModeHelp$ja extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'PixelFileをインストールしていない受信者でも、ブラウザでリンクを開くことで選択したファイルをダウンロードできます。';
}
