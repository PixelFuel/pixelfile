...
class Translations$receiveOptionsPage$pt_PT extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(pasta 像素快传)';
  @override
...
class Translations$webSharePage$pt_PT extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'O 像素快传 utiliza um certificado assinado automaticamente. Precisa de aceitá-lo no navegador.';
  @override
...
class Translations$aboutPage$pt_PT extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Acerca do 像素快传';
  @override
  List<String> get description => [
    'O 像素快传 é uma aplicação gratuita e de código aberto que permite partilhar ficheiros e mensagens de forma segura com dispositivos próximos através da sua rede local, sem a necessidade de uma ligação à Internet.',
...
class Translations$donationPage$pt_PT extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'O 像素快传 é um software gratuito, de código aberto e sem qualquer anúncio. Se gosta da aplicação, considere apoiar o desenvolvimento com um donativo.';
  @override
...
class Translations$tray$pt_PT extends Translations$tray$en {
  ...
  @override
  String get close => 'Fechar o 像素快传';
  @override
...
class Translations$networkInterfacesPage$pt_PT extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Por padrão, o 像素快传 utiliza todas as interfaces de rede disponíveis. Pode excluir as redes indesejadas aqui. É necessário reiniciar o servidor para aplicar as alterações.';
  @override
...
class Translations$settingsTab$general$pt_PT extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Mostrar 像素快传 no menu de contexto';
}
...
class Translations$settingsTab$other$pt_PT extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Suporte o 像素快传';
  @override
...
class Translations$dialogs$localNetworkUnauthorized$pt_PT extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'O 像素快传 não consegue encontrar outros dispositivos sem ter a permissão para analisar a rede local. Conceda esta permissão nas definições.';
  @override
...
class Translations$dialogs$sendModeHelp$pt_PT extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Os destinatários que não têm o 像素快传 instalado podem descarregar os ficheiros selecionados abrindo o link fornecido no navegador.';
}
