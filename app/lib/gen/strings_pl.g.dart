...
class _Translations$webSharePage$pl extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'PixelFile używa samopodpisanego certyfikatu. Musisz go zaakceptować w przeglądarce.';
  @override
...
class _Translations$aboutPage$pl extends Translations$aboutPage$en {
  ...
  List<String> get description => [
    'PixelFile jest darmową, otwartoźródłową aplikacją, która pozwala na bezpieczne udostępnianie plików i wiadomości urządzeniom w pobliżu poprzez Twoją sieć lokalną, bez konieczności połączenia z internetem.',
...
class _Translations$donationPage$pl extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'PixelFile jest darmową, otwartoźródłową aplikacją bez żadnych reklam. Jeśli podoba Ci się aplikacja, możesz wesprzeć jej rozwój darowizną.';
  @override
...
class _Translations$tray$pl extends Translations$tray$en {
  ...
  @override
  String get close => 'Zakończ PixelFile';
  @override
...
class _Translations$networkInterfacesPage$pl extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Domyślnie PixelFile używa wszystkich dostępnych interfejsów sieciowych. Możesz tutaj wykluczyć niechciane sieci. Musisz ponownie uruchomić serwer, aby zastosować zmiany.';
}
...
class _Translations$settingsTab$general$pl extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Pokaż PixelFile w menu kontekstowym';
  @override
...
class _Translations$settingsTab$other$pl extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Wesprzyj PixelFile';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$pl extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'PixelFile nie może znaleźć innych urządzeń bez uprawnienia do skanowania sieci lokalnej. Udziel tego uprawnienia w ustawieniach.';
  @override
...
class _Translations$dialogs$sendModeHelp$pl extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Odbiorcy, którzy nie mają zainstalowanego PixelFile, mogą pobrać wybrane pliki, otwierając link w swojej przeglądarce.';
}
