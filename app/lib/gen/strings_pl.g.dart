...
class _Translations$webSharePage$pl extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 używa samopodpisanego certyfikatu. Musisz go zaakceptować w przeglądarce.';
  @override
...
class _Translations$aboutPage$pl extends Translations$aboutPage$en {
  ...
  List<String> get description => [
    '像素快传 jest darmową, otwartoźródłową aplikacją, która pozwala na bezpieczne udostępnianie plików i wiadomości urządzeniom w pobliżu poprzez Twoją sieć lokalną, bez konieczności połączenia z internetem.',
...
class _Translations$donationPage$pl extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 jest darmową, otwartoźródłową aplikacją bez żadnych reklam. Jeśli podoba Ci się aplikacja, możesz wesprzeć jej rozwój darowizną.';
  @override
...
class _Translations$networkInterfacesPage$pl extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Domyślnie 像素快传 używa wszystkich dostępnych interfejsów sieciowych. Możesz tutaj wykluczyć niechciane sieci. Musisz ponownie uruchomić serwer, aby zastosować zmiany.';
}
...
class _Translations$settingsTab$general$pl extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Pokaż 像素快传 w menu kontekstowym';
  @override
...
class _Translations$settingsTab$other$pl extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Wesprzyj 像素快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$pl extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '像素快传 nie może znaleźć innych urządzeń bez uprawnienia do skanowania sieci lokalnej. Udziel tego uprawnienia w ustawieniach.';
  @override
...
class _Translations$dialogs$sendModeHelp$pl extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Odbiorcy, którzy nie mają zainstalowanego 像素快传, mogą pobrać wybrane pliki, otwierając link w swojej przeglądarce.';
}
