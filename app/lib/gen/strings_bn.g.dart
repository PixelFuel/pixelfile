...
class _Translations$networkInterfacesPage$bn extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      '像素快传 সব অ্যাভেলেবেল নেটওয়ার্ক ইন্টারফেস ব্যবহার করে। আপনি এখানে অপ্রয়োজনীয় নেটওয়ার্ক বাদ দিতে পারেন। কোন পরিবর্তন আনলে সার্ভারটি পুনরায় চালু করতে হবে।';
  @override
...
class _Translations$webSharePage$bn extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 একটি সেল্ফ-সাইন্ড সার্টিফিকেট ব্যবহার করে। আপনাকে ব্রাউজারে এটি একসেপ্ট করতে হবে।';
  @override
...
class _Translations$aboutPage$bn extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => '像素快传 সম্পর্কে';
  @override
  List<String> get description => [
    '像素快传 হল একটি ফ্রী, ওপেন সোর্স অ্যাপ যা ইন্টারনেট ছাড়াই আপনার লোকাল নেটওয়ার্কের ডিভাইসগুলির সাথে ফাইল এবং মেসেজ নিরাপদে শেয়ার করতে দেয়৷',
...
class _Translations$donationPage$bn extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 ফ্রী, ওপেন সোর্স এবং কোনো অ্যাড ছাড়াই। আপনি যদি অ্যাপটি পছন্দ করেন তবে আপনি একটি ডোনেশন দিয়ে ডেভেলপমেন্টকে সাপোর্ট করতে পারেন।';
  @override
...
class _Translations$tray$bn extends Translations$tray$en {
  ...
  @override
  String get close => '像素快传 থেকে বের হোন';
  @override
...
class _Translations$settingsTab$general$bn extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'কনটেক্সট মেনুতে 像素快传 দেখান';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$bn extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'লোকাল নেটওয়ার্ক স্ক্যান করার পারমিশন ছাড়া 像素快传 অন্য ডিভাইস খুঁজে পায় না। অনুগ্রহ করে সেটিংসে এই পারমিশনটি দিন।';
  @override
...
class _Translations$dialogs$sendModeHelp$bn extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'যাদের 像素快传 ইনস্টল করা নেই তারা ব্রাউজারে লিঙ্কটি খুলে ফাইলগুলি ডাউনলোড করতে পারবেন।';
}
