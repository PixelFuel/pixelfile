...
class _Translations$webSharePage$es_ES extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 utiliza un certificado autofirmado. Necesitas aceptarlo en el navegador.';
  @override
...
class _Translations$aboutPage$es_ES extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Sobre 像素快传';
  @override
  List<String> get description => [
    '像素快传 es una aplicación libre, de código abierto, que te permite compartir archivos y mensajes de forma segura con dispositivos cercanos a través de tu red local sin necesidad de conexión a Internet.',
...
class _Translations$donationPage$es_ES extends Translations$donationPage$en {
  ...
  @override
  String get info => '像素快传 es libre, open source y no contiene anuncios. Si te gusta la aplicación puedes ayudar al desarrollo con una donación.';
  @override
...
class _Translations$networkInterfacesPage$es_ES extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'De forma predeterminada, 像素快传 utiliza todas las interfaces de red disponibles. Aquí puede desactivar las redes no deseadas. Debe reiniciar el servidor para aplicar los cambios.';
  @override
  String get preview => 'Vista previa';
  @override
...
class _Translations$settingsTab$general$es_ES extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Mostrar 像素快传 en el menú contextual';
  @override
...
class _Translations$settingsTab$other$es_ES extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Apoya a 像素快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$es_ES extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '像素快传 no puede encontrar otros dispositivos sin tener permiso para escanear la red local. Por favor, concede este permiso en los ajustes.';
  @override
...
class _Translations$dialogs$sendModeHelp$es_ES extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Los destinatarios que no tengan 像素快传 instalado pueden descargar los archivos seleccionados abriendo el enlace en su navegador.';
}
