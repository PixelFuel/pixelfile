...
class _Translations$receiveOptionsPage$ne extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(像素快传 फोल्डर)';
  @override
...
class _Translations$webSharePage$ne extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 एक स्वयंसिग्ध प्रमाणपत्र प्रयोग गर्दछ। तपाईंले ब्राउजरमा यसलाई स्वीकार्नु पर्दछ।';
  @override
...
class _Translations$aboutPage$ne extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => '像素快传 को बारेमा';
  @override
  List<String> get description => [
    '像素快传 एउटा नि:शुल्क, खुला स्रोत एप हो जसले तपाईंलाई इन्टरनेट जडानको आवश्यकता बिना नै आफ्नो स्थानीय नेटवर्कमा नजिकैका उपकरणहरूसँग फाइलहरू र सन्देशहरू सुरक्षित रूपमा साझेदारी गर्न अनुमति दिन्छ।',
...
class _Translations$tray$ne extends Translations$tray$en {
  ...
  @override
  String get close => '像素快传 बन्द गर्नुहोस्';
  @override
...
class _Translations$networkInterfacesPage$ne extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'पूर्वनिर्धारित रूपमा, 像素快传 ले सबै उपलब्ध नेटवर्क इन्टरफेसहरू प्रयोग गर्दछ। तपाईं यहाँ अनावश्यक नेटवर्कहरू बहिष्कार गर्न सक्नुहुन्छ। परिवर्तनहरू लागू गर्न तपाईंले सर्भर पुन: सुरु गर्न आवश्यक छ।';
}
...
class _Translations$donationPage$ne extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 नि:शुल्क, खुला स्रोत र कुनै पनि विज्ञापन बिनाको एप हो। यदि तपाईंलाई एप मनपर्छ भने, तपाईंले दान दिएर विकासलाई समर्थन गर्न सक्नुहुन्छ।';
  @override
...
class _Translations$settingsTab$general$ne extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'कन्टेक्स्ट मेनुमा 像素快传 देखाउनुहोस्';
}
...
class _Translations$settingsTab$other$ne extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => '像素快传 लाई समर्थन गर्नुहोस्';
}
...
class _Translations$dialogs$localNetworkUnauthorized$ne extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => '像素快传 ले स्थानीय नेटवर्क स्क्यान गर्ने अनुमति बिना अन्य उपकरणहरू फेला पार्न सक्दैन। कृपया सेटिङहरूमा यो अनुमति दिनुहोस्।';
  @override
...
class _Translations$dialogs$sendModeHelp$ne extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => '像素快传 इन्स्टल नगरेका प्राप्तकर्ताहरूले आफ्नो ब्राउजरमा लिङ्क खोलेर चयन गरिएका फाइलहरू डाउनलोड गर्न सक्छन्।';
}
