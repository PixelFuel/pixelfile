...
class _Translations$receiveOptionsPage$et extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(像素快传i kaust)';
  @override
...
class _Translations$webSharePage$et extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 kasutab enda poolt allkirjastatud sertifikaate. Ühenduse toimimiseks palun nõustu nendega veebibrauseris.';
  @override
...
class _Translations$aboutPage$et extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Rakenduse teave: 像素快传';
  @override
  List<String> get description => [
    '像素快传 põhineb avatud lähtekoodil, on kõikide jaoks vaba ning tasuta kasutatav. Rakenduse eesmärgiks on võimaldada failide ja tekstide jagamist kohtvõrgus asuvate arvutite vahel nii, et välist internetiühendust pole vaja kasutada.',
...
class _Translations$donationPage$et extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 põhineb avatud lähtekoodil, on kõikide jaoks vaba ning tasuta kasutatav, ega sisalda reklaame. Kui sulle see rakendus meeldib, siis palun toeta meie arendust.';
  @override
...
class _Translations$networkInterfacesPage$et extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Vaikimisi kasutab 像素快传 kõiki võrguliideseid. Kui sul on vaja, siis saad mittesoovitud võrgud siinkohal välistada ning muudatuste jõustumine eeldab serverikomponendi uuesti käivitamist.';
}
...
class _Translations$settingsTab$general$et extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Näita 像素快传i kontekstimenüüs';
  @override
...
class _Translations$settingsTab$other$et extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Toeta 像素快传i';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$et extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Ilma kohtvõrgu skaneerimise õiguseta ei suuda 像素快传 leida teisi seadmeid. Palun luba süsteemi seadistustest vajalikud õigused.';
  @override
...
class _Translations$dialogs$sendModeHelp$et extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Kui failide vastuvõtjatel pole arvutis või nutiseadmes rakendust 像素快传, siis avades etteantud lingi oma veebibrauseris, saavad nad failid alla laadida.';
}
