...
class _Translations$receiveOptionsPage$el extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Φάκελος 像素快传)';
  @override
...
class _Translations$webSharePage$el extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Το 像素快传 χρησιμοποιεί αυτο-υπογεγραμμένο πιστοποιητικό. Χρειάζεται να το αποθεχτείτε στον φυλλομετρητή.';
  @override
...
class _Translations$aboutPage$el extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Σχετικά με το 像素快传';
  @override
  List<String> get description => [
    'Το 像素快传 είναι μια δωρεάν εφαρμογή ανοιχτού κώδικα που σας επιτρέπει να μοιράζεστε με ασφάλεια αρχεία και μηνύματα με κοντινές συσκευές μέσω του τοπικού σας δικτύου χωρίς να χρειάζεστε σύνδεση στο διαδίκτυο.',
...
class _Translations$donationPage$el extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Το 像素快传 είναι δωρεάν, ανοιχτού κώδικα και χωρίς διαφημίσεις. Εάν σας αρέσει η εφαρμογή, μπορείτε να υποστηρίξετε την ανάπτυξή της με μια δωρεά.';
  @override
...
class _Translations$tray$el extends Translations$tray$en {
  ...
  @override
  String get close => 'Έξοδος από το 像素快传';
  @override
...
class _Translations$networkInterfacesPage$el extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Από προεπιλογή, το 像素快传 χρησιμοποιεί όλες τις διαθέσιμες διεπαφές δικτύου. Μπορείτε να εξαιρέσετε τα ανεπιθύμητα δίκτυα εδώ. Πρέπει να κάνετε επανεκκίνηση του διακομιστή για να εφαρμόσετε τις αλλαγές.';
  @override
...
class _Translations$settingsTab$general$el extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Προβολή του 像素快传 στο μενού του περιβάλλοντος εργασίας';
  @override
...
class _Translations$settingsTab$other$el extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Υποστηρίξτε το 像素快传';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$el extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Το 像素快传 δεν μπορεί να βρει άλλες συσκευές χωρίς την άδεια σάρωσης του τοπικού δικτύου. Παρακαλείστε να παραχωρήσετε αυτό το δικαίωμα στις ρυθμίσεις.';
  @override
...
class _Translations$dialogs$sendModeHelp$el extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Οι παραλήπτες που δεν έχουν εγκαταστήσει το 像素快传 μπορούν να πραγματοποιήσουν λήψη των επιλεγμένων αρχείων ανοίγοντας τον σύνδεσμο στον φυλλομετρητή τους.';
}
