...
class _Translations$receiveOptionsPage$ta extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(像素快传 கோப்புறை)';
  @override
...
class _Translations$webSharePage$ta extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => '像素快传 ஒரு சுய கையொப்பம் செய்யப்பட்ட சான்றிதழைப் பயன்படுத்துகிறது. உங்களின் உலாவியில் அதை ஏற்க வேண்டும்.';
  @override
...
class _Translations$aboutPage$ta extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => '像素快传 பற்றி';
  @override
  List<String> get description => [
    '像素快传 என்பது ஒரு இலவச, திறந்த மூல செயலி ஆகும், இது உங்களுக்கு உங்களின் உள்ளூர் நெட்வொர்க்கின் மூலம் அருகிலுள்ள சாதனங்களுடன் இணையம் தேவையின்றி பாதுகாப்பாக கோப்புகள் மற்றும் செய்திகளை பகிர அனுமதிக்கிறது.',
...
class _Translations$donationPage$ta extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      '像素快传 இலவசம், திறந்த மூலமாக உள்ளது மற்றும் விளம்பரங்களின்றி உள்ளது. செயலியை நீங்கள் விரும்பினால், ஒரு தானம் மூலம் வளர்ச்சியை ஆதரிக்கலாம்.';
  @override
...
class _Translations$tray$ta extends Translations$tray$en {
  ...
  @override
  String get close => '像素快传-ஐ நிறுத்து';
  @override
...
class _Translations$settingsTab$general$ta extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'சூழல் மெனுவில் 像素快传 ஐக் காட்டு';
  @override
...
class _Translations$settingsTab$other$ta extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => '像素快传 ஐ ஆதரிக்க';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ta extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      '像素快传 உள்நாட்டு நெட்வொர்க்கை ஸ்கேன் செய்ய அனுமதியின்றி சாதனங்களை கண்டறிய முடியாது. தயவுசெய்து அமைப்புகளில் இந்த அனுமதியை வழங்கவும்.';
  @override
...
class _Translations$dialogs$sendModeHelp$ta extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => '像素快传 நிறுவப்படாத பெறுநர்கள் தங்கள் உலாவியில் இணைப்பைத் திறக்க மூலம் தேர்ந்தெடுக்கப்பட்ட கோப்புகளை பதிவிறக்கம் செய்ய முடியும்.';
}
